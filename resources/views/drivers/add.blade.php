...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="m-portlet">
            ...
            <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{route('driver_store')}}" method="POST">
            {{ csrf_field() }}
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <input type="text" class="form-control m-input m-input--solid" name="license_no" id="license_no" value="{{ old('license_no') }}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <div class="m-typeahead">
                                    <input class="form-control m-input m-input--solid" id="m_typeahead_1" name="state" type="text" />
                                </div>
                            </div>
                        </div>
                    </div>
